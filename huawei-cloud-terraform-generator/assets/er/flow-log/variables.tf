...
variable "lts_group_name" {
  description = "The LTS group name"
  type        = string
}
...
variable "lts_stream_name" {
  description = "The LTS stream name"
  type        = string
}

variable "er_flow_log_name" {
  description = "The ER flow log name"
  type        = string
}

variable "er_flow_log_store_type" {
  description = "The storage type of flow log"
  type        = string
  default     = "LTS"
}

variable "er_flow_log_resource_type" {
  description = "The resource type to which the logs to be collected"
  type        = string
  default     = "attachment"
}
