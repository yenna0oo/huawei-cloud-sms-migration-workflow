...
variable "key_alias" {
  ...
  validation {
    ...
    error_message = "The key_alias must be set when bucket_encryption or object_encryption is true and bucket_encryption_key_id is not set."
  }
}
...
variable "object_encryption" {
  description = "The encryption of the OBS object"
  type        = bool
  default     = true
}
